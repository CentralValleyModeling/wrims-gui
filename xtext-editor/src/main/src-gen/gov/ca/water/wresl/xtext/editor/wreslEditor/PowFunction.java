 ...
 * <ul>
 *   <li>{@link PowFunction#getE1 <em>E1</em>}</li>
 *   <li>{@link PowFunction#getE2 <em>E2</em>}</li>
 * </ul>
 * </p>
 *
 * @see WreslEditorPackage#getPowFunction()
 * @model
 * @generated
 */
public interface PowFunction extends Function
{
   ...
   * @see WreslEditorPackage#getPowFunction_E1()
  ...
  /**
   * Sets the value of the '{@link PowFunction#getE1 <em>E1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see WreslEditorPackage#getPowFunction_E2()
   * @model containment="true"
   * @generated
   */
  Expression getE2();
  ...
  /**
   * Sets the value of the '{@link PowFunction#getE2 <em>E2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
