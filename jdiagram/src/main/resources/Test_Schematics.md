Feature: Test schematics
  As users of the wrims, we want to load and operate a schematic
...
3. Use "Zoom to Rectangle" button zoom to a small domain to avoid two much dss data is loaded on the schematic; move the focused area using the rectangle in the "Schamtic Overview". 
