...
8. Go back to the `Schematic` view, select time period of `Oct 1928 to Sep 1934`. The schematic will show the average values during the period of `Oct 1928 to Sep 1934` in TAF unit for both alternatives.
