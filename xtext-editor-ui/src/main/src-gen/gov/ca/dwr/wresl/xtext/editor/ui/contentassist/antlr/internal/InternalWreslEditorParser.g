...
@members {
 	...
 	
 	{
		...
		tokenNameToValue.put("I_1", "'i='");
		tokenNameToValue.put("Lhs", "'LHS'");
		tokenNameToValue.put("Rhs", "'RHS'");
		tokenNameToValue.put("Std", "'STD'");
		tokenNameToValue.put("Sum", "'SUM'");
		tokenNameToValue.put("Use", "'USE'");
		tokenNameToValue.put("Apr", "'apr'");
		tokenNameToValue.put("Aug", "'aug'");
		tokenNameToValue.put("Day", "'day'");
		tokenNameToValue.put("Dec", "'dec'");
		tokenNameToValue.put("Feb", "'feb'");
		tokenNameToValue.put("Jan", "'jan'");
		tokenNameToValue.put("Jul", "'jul'");
		tokenNameToValue.put("Jun", "'jun'");
		tokenNameToValue.put("Lhs", "'lhs'");
		tokenNameToValue.put("Mar", "'mar'");
		tokenNameToValue.put("May", "'may'");
		tokenNameToValue.put("Nov", "'nov'");
		tokenNameToValue.put("Oct", "'oct'");
		tokenNameToValue.put("Rhs", "'rhs'");
		tokenNameToValue.put("Sep", "'sep'");
		tokenNameToValue.put("Std", "'std'");
		tokenNameToValue.put("Sum", "'sum'");
		tokenNameToValue.put("Use", "'use'");
		tokenNameToValue.put("Dll", "'.DLL'");
		tokenNameToValue.put("Dll", "'.dll'");
		tokenNameToValue.put("DAY", "'1DAY'");
		tokenNameToValue.put("MON", "'1MON'");
		tokenNameToValue.put("Case", "'CASE'");
		tokenNameToValue.put("Dvar_1", "'DVAR'");
		tokenNameToValue.put("Dvar_1", "'Dvar'");
		tokenNameToValue.put("From", "'FROM'");
		tokenNameToValue.put("Goal", "'GOAL'");
		tokenNameToValue.put("Kind", "'KIND'");
		tokenNameToValue.put("Svar_1", "'SVAR'");
		tokenNameToValue.put("Svar_1", "'Svar'");
		tokenNameToValue.put("Case", "'case'");
		tokenNameToValue.put("Dvar_1", "'dvar'");
		tokenNameToValue.put("From", "'from'");
		...
		tokenNameToValue.put("Const_1", "'CONST'");
		tokenNameToValue.put("Const_1", "'Const'");
		...
		tokenNameToValue.put("Af_cfs", "'af_cfs'");
		tokenNameToValue.put("Cfs_af", "'cfs_af'");
		tokenNameToValue.put("Daysin", "'daysin'");
		tokenNameToValue.put("Define", "'define'");
		tokenNameToValue.put("Select", "'select'");
		tokenNameToValue.put("Convert", "'CONVERT'");
		tokenNameToValue.put("Declare", "'Declare'");
		tokenNameToValue.put("Include", "'INCLUDE'");
		tokenNameToValue.put("Initial_1", "'INITIAL'");
		tokenNameToValue.put("Integer", "'INTEGER'");
		tokenNameToValue.put("Initial_1", "'Initial'");
		tokenNameToValue.put("Penalty", "'PENALTY'");
		tokenNameToValue.put("Cfs_taf", "'cfs_taf'");
		tokenNameToValue.put("Convert", "'convert'");
		tokenNameToValue.put("Include", "'include'");
		tokenNameToValue.put("Initial_1", "'initial'");
		tokenNameToValue.put("Integer", "'integer'");
		tokenNameToValue.put("Penalty", "'penalty'");
		tokenNameToValue.put("Prevapr", "'prevapr'");
		tokenNameToValue.put("Prevaug", "'prevaug'");
		tokenNameToValue.put("Prevdec", "'prevdec'");
		tokenNameToValue.put("Prevfeb", "'prevfeb'");
		tokenNameToValue.put("Prevjan", "'prevjan'");
		tokenNameToValue.put("Prevjul", "'prevjul'");
		tokenNameToValue.put("Prevjun", "'prevjun'");
		tokenNameToValue.put("Prevmar", "'prevmar'");
		tokenNameToValue.put("Prevmay", "'prevmay'");
		tokenNameToValue.put("Prevnov", "'prevnov'");
		tokenNameToValue.put("Prevoct", "'prevoct'");
		tokenNameToValue.put("Prevsep", "'prevsep'");
		tokenNameToValue.put("Taf_cfs", "'taf_cfs'");
		tokenNameToValue.put("External", "'EXTERNAL'");
		tokenNameToValue.put("Sequence", "'SEQUENCE'");
		tokenNameToValue.put("External", "'external'");
		tokenNameToValue.put("Sequence", "'sequence'");
		tokenNameToValue.put("Timestep", "'timestep'");
		tokenNameToValue.put("Condition", "'CONDITION'");
		tokenNameToValue.put("Constrain", "'CONSTRAIN'");
		tokenNameToValue.put("Objective", "'OBJECTIVE'");
		tokenNameToValue.put("Unbounded", "'UNBOUNDED'");
		tokenNameToValue.put("Condition", "'condition'");
		tokenNameToValue.put("Constrain", "'constrain'");
		tokenNameToValue.put("Objective", "'objective'");
		tokenNameToValue.put("Unbounded", "'unbounded'");
		tokenNameToValue.put("Wateryear", "'wateryear'");
		tokenNameToValue.put("Timeseries", "'TIMESERIES'");
		tokenNameToValue.put("Timeseries", "'timeseries'");
		tokenNameToValue.put("Daysinmonth", "'daysinmonth'");
		tokenNameToValue.put("Daysintimestep", "'daysintimestep'");
 	}
