...
.. _51-debug-compare-existing-studies:

5.1 Debug Compare Existing Studies
----------------------------------
...
WRIMS 3 GUI allows up to eight alternatives:
...
.. _52-debug-filter-goals:

5.2 Debug Filter Goals
----------------------
...
For the controlling-goal concept and tolerance behavior, see :ref:`2.4 Controlling Goals and Goal Tolerance <24-controlling-goals-and-goal-tolerance>`.
...
The tolerance rules are described in :ref:`2.4 Controlling Goals and Goal Tolerance <24-controlling-goals-and-goal-tolerance>`.
...
WRIMS 3 GUI displays a dialog with the filtered goals and indicates which of them are controlling under the specified tolerance.
...
.. _53-debug-force-variable-resimulation:

5.3 Debug Force Variable Resimulation
-------------------------------------
