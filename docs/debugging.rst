...
.. _09-debug-pause-variable-goal-view:
...
For this distinction, see :ref:`Variable and Goal Views <variable-and-goal-views>`.
...
- :ref:`10. Debug Variable Monitor <10-debug-variable-monitor>`
...
- :ref:`11. Debug Variable Detail <11-debug-variable-detail>`
- :ref:`12. Debug Watch Variables Goals <12-debug-watch-variables-goals>`


.. _11-debug-variable-detail:
...
.. _12-debug-watch-variables-goals:
...
.. _15-debug-error-source-code-link:
...
- :ref:`09. Debug Pause Variable Goal View <09-debug-pause-variable-goal-view>`
- :ref:`17. Debug Find Reference <17-debug-find-reference>`
- :ref:`20. Debug Study Cycle WRESL <20-debug-study-cycle-wresl>`


.. _16-debug-conditional-breakpoint:
