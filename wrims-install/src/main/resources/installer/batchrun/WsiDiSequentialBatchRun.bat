...
"%WRIMS_JAVA%" -Djava.library.path="lib" -cp "dropins\plugins\*;plugins\*;lib\*" gov.ca.water.wrims.gui.ide.batchrun.WsiDiBatchRunCmd "batchrun\WsiDiLaunchFileGroup.lfg"
