...
import gov.ca.water.hecdssvue.monthly.MonthlyTableModel.SingleMonthlyTable;
...
//				int lineIdx = 0;
				...
				if (header instanceof MonthlyTableModel.SingleMonthlyTable.GroupableTableHeader)
				{
					...
					int headerLine;
					Enumeration cGroups;
					MonthlyTableModel.SingleMonthlyTable.ColumnGroup cGroup;
					...
					while (enumerator.hasMoreElements())
					{
						...
						cnt++;
						cGroups = ((MonthlyTableModel.SingleMonthlyTable.GroupableTableHeader) header).getColumnGroups(aColumn);
						if (cGroups != null)
						{
							first = true;
							headerLine = 0;
							while (cGroups.hasMoreElements())
							{
								colWidth = 0;
								headerLine++;
								cGroup = (MonthlyTableModel.SingleMonthlyTable.ColumnGroup) cGroups.nextElement();
